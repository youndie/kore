...
| [B-07](docs/backlog/B-07-native-link-cost.md) `[ ]` | Measure what a native link costs CI, and decide the gate's cadence | P1 | S | B-01 |
...
| [B-15](docs/backlog/B-15-booblik-adapter.md) `[ ]` | The booblik participant: flush, then close (JVM only) | P1 | S | B-11 |
...
| [B-28](docs/backlog/B-28-observability-wiring.md) `[ ]` | The three agents in one call, with three shutdown contracts | P1 | M | B-11, B-21 |
