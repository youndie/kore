...
|---|---|---|---|---|
| [B-49](docs/backlog/B-49-arm64-suites-never-run.md) `[~]` | The priority target has never run a test | P1 | M | - |
| [B-50](docs/backlog/B-50-sample-uses-the-config-schema.md) `[ ]` | The sample does not use the configuration schema | P2 | M | - |
| [B-51](docs/backlog/B-51-anchors-inside-artefacts.md) `[?]` | An address inside an artefact is not a rotten anchor | P3 | S | - |
...
- [B-45](docs/backlog/B-45-booblik-against-a-real-broker.md) `[x]` - The booblik participant against a real broker
...
- [B-20](docs/backlog/B-20-pre-drain-default.md) `[x]` - Measure and settle the pre-drain default
- [B-40](docs/backlog/B-40-sample-pooled-store.md) `[x]` - Give the sample a real pooled store the oracle can stop underneath it
- [B-41](docs/backlog/B-41-nothing-starts-the-health-loop.md) `[x]` - Nothing starts the health refresh loop
- [B-47](docs/backlog/B-47-driver-behaviour-check.md) `[x]` - Check that a pool really does hand out a dead connection
...
- [B-29](docs/backlog/B-29-profiler-hook.md) `[x]` - Decide the shape of the profiler hook, or drop it
...
- [B-46](docs/backlog/B-46-run-until-signal.md) `[x]` - Collapse signal-to-sequence into one call
...
- [B-33](docs/backlog/B-33-publish-and-adopt.md) `[x]` - Publish kore and adopt it in the first consumer
